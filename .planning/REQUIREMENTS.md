...
- [x] **OPAQUE-03**: User can opt into summary contract inference for opaque callees via `#[verifier::infer_summary]`, which auto-generates minimal read/write contracts without manual annotation
